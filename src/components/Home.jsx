...
const Home = () => {
  ...
  return (
    ...
    >
      <h1 className="text-3xl mb-8 pt-6 font-bold">Global Crypto Stats</h1>
      <div className="">
        <div className="stats grid grid-cols-2 gap-4">
          <div className="">
            <p className="text-gray-500 text-md mb-2">Total Cryptocurrencies</p>
            <span className="text-lg font-semibold ps-2">
              {globalStats[0]?.total}
            </span>
          </div>
          <div className="">
          ...
          <div className="">
            ...
            <span className="text-lg font-semibold ps-2">{`$${millify(
      ...
      <div className="flex items-center justify-between">
        <h1 className="text-3xl mb-9 pt-9 font-bold">Top 10 CryptoCurrency</h1>
        <Link to="/Cryptocurrencies">
          <h3 className="text-blue-500 text-xl font-semibold">Show More</h3>
        </Link>
      </div>
      <Cryptocurrencies />
      <div className="flex items-center justify-between">
        <h1 className="text-3xl mb-9 pt-9 font-bold">Latest Crypto News</h1>
        <Link to="/news">
          <h3 className="text-blue-500 text-xl font-semibold">Show More</h3>
        </Link>
      </div>
